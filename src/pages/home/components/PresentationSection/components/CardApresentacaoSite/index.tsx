...
const CardApresentacaoSite: React.FC = () => {
    return (
        <div className="card-apresentacao-site">
            ...
            <p>Pronto para dominar a arte da segurança digital? 
            <br/>
                No SafeApps, você vai descobrir como proteger suas contas e se manter longe dos riscos online, tudo de um jeito simples e divertido.</p>
            <br/>
